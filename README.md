...
# Industrial Electronics Skills Competition

**한국 전국기능경기대회(공업전자기기) 준비 자료 — PCB 설계 · 임베디드 C · 회로설계 연습**

![Competition](https://img.shields.io/badge/competition-Korea%20Skills%20Competition-2b6cb0)
![Trade](https://img.shields.io/badge/trade-Industrial%20Electronics-4a5568)
![Awards](https://img.shields.io/badge/awards-Gold%20%C2%B7%20Merit%20%C2%B7%20Excellence-d4a017)
![Verified](https://img.shields.io/badge/results-officially%20verified-2f855a)
...
| 폴더 | 내용 |
|---|---|
| [`2019-regional-competition/task1-hardware-design`](./2019-regional-competition/task1-hardware-design) | ✅ 1과제 PCB 설계 — 시간 반복 카운터 (Gerber + 렌더 이미지) |
| [`2019-national-competition/task1-lead-smoke-remover`](./2019-national-competition/task1-lead-smoke-remover) | ✅ 1과제 PCB 설계 — "납 연기 제거기" (Gerber + 렌더 이미지) |
| [`elevator-control-system`](./elevator-control-system) | ✅ 54회 전국 3과제 — 2대 엘리베이터 제어 C 코드 (ATmega128, UART) |
| [`motor-pwm-control`](./motor-pwm-control) | PWM 모터 속도 제어 + 7세그먼트 (ATmega128, 인터럽트) |
| [`circuit-design-practice-log`](./circuit-design-practice-log) | OrCAD 회로설계/PCB 레이아웃 연습 39세션 (2019.08.15~10.04) |
| [`circuit-design-problem-set`](./circuit-design-problem-set) | 회로설계 연습 문제·정답 7종 |
| [`photos`](./photos) | 실제 촬영한 답안지·배선 작업·오실로스코프 측정 사진 |
| [`2018-regional-competition`](./2018-regional-competition) · [`2019-regional-competition`](./2019-regional-competition) · [`2019-national-competition`](./2019-national-competition) | 대회별 전체 1~5과제 문서화 (설계 파일이 없는 과제도 무엇을 했는지 상세 설명) |

### 미리보기

<table>
<tr>
<td width="33%"><img src="./2019-national-competition/task1-lead-smoke-remover/pcb1/render/02-bottom-copper.png" width="100%"><br><sub>PCB 배선 렌더링 (54회 전국 1과제)</sub></td>
<td width="33%"><img src="./photos/national-task4-vending-machine-panel-wiring.jpg" width="100%"><br><sub>실제 패널 배선 작업</sub></td>
<td width="33%"><img src="./photos/oscilloscope-measurement-1.jpg" width="100%"><br><sub>오실로스코프 측정</sub></td>
</tr>
</table>

### 공식 입상 확인

한국산업인력공단이 운영하는 마이스터넷(Meister Net) [입상자 조회](https://meister.hrdkorea.or.kr/sub/3/6/7/skillMatchTournament/prizeWinnerList.do)에서 직종 "공업전자기기", 소속시도 "서울", 성명 "김진영"으로 검색하면 아래 결과를 직접 확인할 수 있습니다.
...
<details>
<summary><b>대회별 전체 과제(1~5과제) 구성표 (펼쳐보기)</b></summary>
...
**Results** (independently verifiable on Meister Net — see below)
...
| Folder | Contents |
|---|---|
| [`2019-regional-competition/task1-hardware-design`](./2019-regional-competition/task1-hardware-design) | ✅ Task 1 PCB design — repeating interval counter (Gerber + rendered layers) |
| [`2019-national-competition/task1-lead-smoke-remover`](./2019-national-competition/task1-lead-smoke-remover) | ✅ Task 1 PCB design — "lead smoke remover" (Gerber + rendered layers) |
| [`elevator-control-system`](./elevator-control-system) | ✅ 54th National Task 3 — dual-elevator control C code (ATmega128, UART) |
| [`motor-pwm-control`](./motor-pwm-control) | PWM motor speed control + 7-segment display (ATmega128, interrupt-driven) |
| [`circuit-design-practice-log`](./circuit-design-practice-log) | 39 sessions of daily OrCAD circuit/PCB layout practice (2019-08-15 to 10-04) |
| [`circuit-design-problem-set`](./circuit-design-problem-set) | 7 self-assembled circuit design practice problems with solutions |
| [`photos`](./photos) | Real photos: answer sheets, wiring work, oscilloscope measurements |
| [`2018-regional-competition`](./2018-regional-competition) · [`2019-regional-competition`](./2019-regional-competition) · [`2019-national-competition`](./2019-national-competition) | Full 1–5 task documentation per competition (what I actually did, even for tasks with no surviving design files) |

### Preview

<table>
<tr>
<td width="33%"><img src="./2019-national-competition/task1-lead-smoke-remover/pcb1/render/02-bottom-copper.png" width="100%"><br><sub>PCB routing render (54th National, Task 1)</sub></td>
<td width="33%"><img src="./photos/national-task4-vending-machine-panel-wiring.jpg" width="100%"><br><sub>Real panel wiring in progress</sub></td>
<td width="33%"><img src="./photos/oscilloscope-measurement-1.jpg" width="100%"><br><sub>Oscilloscope measurement</sub></td>
</tr>
</table>
...
<details>
<summary><b>Full task breakdown per competition (click to expand)</b></summary>
